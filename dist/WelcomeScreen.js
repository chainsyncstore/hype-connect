  ...
  (0, _react.useEffect)(function () {
    var handleTouchStart = function handleTouchStart(event) {
      ...
      console.log('Touch start detected:', {
        identifier:
          (_event$touches$ = event.touches[0]) == null
            ? void 0
            : _event$touches$.identifier,
        pageX:
          (_event$touches$2 = event.touches[0]) == null
            ? void 0
            : _event$touches$2.pageX,
        pageY:
          (_event$touches$3 = event.touches[0]) == null
            ? void 0
            : _event$touches$3.pageY,
