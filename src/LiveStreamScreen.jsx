          ...
          <View className="mt-auto">
            ...
            <View className="flex-row space-x-2">
                <TouchableOpacity
                    ...
                    className="bg-gray-600 hover:bg-gray-500 flex-1 rounded-full py-2 items-center" // Changed Send button color
                    >
                    <Text className="text-white font-semibold text-xs">Send</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    onPress={handleSendTip}
                    className="bg-accent hover:bg-yellow-600 flex-1 rounded-full py-2 items-center" // Changed Tip button to accent
                    >
