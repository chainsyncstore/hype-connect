...
const BookNowModal = ({ isVisible, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="relative flex size-full min-h-screen flex-col bg-[#221c11] dark justify-between group/design-root overflow-x-hidden"
          ...
          <div className="flex absolute top-0 left-0 h-full w-full flex-col justify-end items-stretch bg-[#141414]/40">
            <div className="flex flex-col items-stretch bg-[#221c11]">
              ...
              <div className="flex-1">
                <h1 className="text-white text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 text-left pb-3 pt-5">Book Now</h1>
                <div className="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
                  <label className="flex flex-col min-w-40 flex-1">
                    <select
                      className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-white focus:outline-0 focus:ring-0 border-none bg-[#483a23] focus:border-none h-14 bg-[image:--select-button-svg] placeholder:text-[#c9b592] p-4 text-base font-normal leading-normal"
                    >
                ...
                <h3 className="text-white text-lg font-bold leading-tight tracking-[-0.015em] px-4 pb-2 pt-4">Estimated Cost</h3>
                <p className="text-white text-base font-normal leading-normal pb-3 pt-1 px-4">$250</p>
              </div>
            </div>
          </div>
        </div>
        <div>
          <div className="flex px-4 py-3">
            <button
              className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 px-5 flex-1 bg-[#eead3e] text-[#221c11] text-base font-bold leading-normal tracking-[0.015em]"
            >
