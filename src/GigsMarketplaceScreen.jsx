...
const GigsMarketplaceScreen = ({ navigation }) => {
    ...
    const mockGigs = [
      {
        ...
        category: 'Music Production', deliveryTime: '3 days', image: placeholderGigImage,
      },
      {
        id: '2',
        ...
        category: 'Photography', deliveryTime: '1 week', image: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fGV2ZW50JTIwcGhvdG9ncmFwaHl8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=300&q=60' },
      },
      {
        id: '3',
        ...
        category: 'Graphic Design', deliveryTime: '5 days', image: 'https://images.unsplash.com/photo-1607298799009-a47ab5ee4592?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8bG9nbyUyMGRlc2lnbnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=300&q=60' },
      },
       {
        id: '4',
        ...
        category: 'Videography', deliveryTime: '4 days', image: 'https://images.unsplash.com/photo-1574717024653-61fd2cf4d444?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fHZpZGVvJTIwZWRpdGluZ3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=300&q=60' },
      },
    ];
  ...
  const GigCard = ({ item }) => (
    <View className="flex-1 bg-gray-800 rounded-xl m-2 overflow-hidden max-w-sm">
      {/* Make the top part (image and info) navigable to GigDetail */}
  ...
  return (
    <View className="flex-1 bg-primary">
      ...
      <View className="px-4 pt-4 pb-2 bg-primary">
        <Text className="text-white text-2xl font-bold mb-3">Gigs Marketplace</Text>
        <TextInput
